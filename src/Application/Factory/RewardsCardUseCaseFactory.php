...
class RewardsCardUseCaseFactory implements UseCaseFactoryInterface
{
     ...
     * @param RequestInterface $payload 請求資料。
     *
     ...
     * @return void
     *
     * @throws RequestTypeException 當 payload 不是 RequestInterface 時。
     */
    protected function validatePayload($payload): void
    {
        if (!$payload instanceof RequestInterface) {
            throw new RequestTypeException('RewardsCard request payload must implement RequestInterface.');
        }
    }
}
